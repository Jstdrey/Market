...
def show_backtest_tab(available_strategies):  # Создаем функцию, которая выводит вкладку бектеста и запускает симуляцию по кнопке.
...
def show_optimization_tab(available_strategies):  # Создаем функцию, которая выводит вкладку оптимизации и запускает перебор параметров по кнопке.
...
def main():  # Создаем главную функцию приложения Streamlit.
    ...
    with backtest_tab:  # Открываем контекст второй вкладки.
        show_backtest_tab(available_strategies=available_strategies)  # Рисуем содержимое вкладки бектеста с динамическим выбором стратегии.
    with optimization_tab:  # Открываем контекст третьей вкладки.
        show_optimization_tab(available_strategies=available_strategies)  # Рисуем содержимое вкладки оптимизации параметров стратегии.
